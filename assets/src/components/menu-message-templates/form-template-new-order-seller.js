...
const PageFormTemplateNewOrder = () => {
	...
	const handleSentNewOrderSeller = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/new-order-seller',
				fetchOptions
			);
	...
	const handleSentUpdateOrderSeller = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/update-order-seller',
				fetchOptions
			);
	...
	const handleSentDeleteOrderSeller = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/delete-order-seller',
				fetchOptions
			);
