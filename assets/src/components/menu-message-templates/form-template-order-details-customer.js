...
const PageFormTemplateOrderDetailsCustomer = () => {
	...
	const handleSentNewOrderCustomer = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/new-order-details-customer',
				fetchOptions
			);
	...
	const handleSentUpdateOrderCustomer = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/update-order-details-customer',
				fetchOptions
			);
	...
	const handleSentDeleteOrderCustomer = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/delete-order-details-customer',
				fetchOptions
			);
