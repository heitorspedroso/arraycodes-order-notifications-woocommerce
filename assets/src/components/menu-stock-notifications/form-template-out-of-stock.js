...
const PageFormTemplateOutOfStockCustomer = () => {
	...
	const handleSentNewOutOfStockCustomer = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/new-out-of-stock-customer',
				fetchOptions
			);
	...
	const handleSentUpdateOutOfStockCustomer = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/update-out-of-stock-customer',
				fetchOptions
			);
	...
	const handleSentDeleteOutOfStockCustomer = async () => {
		...
		try {
			...
			const response = await fetch(
				'/wp-json/notifications-with-whatsapp/v1/delete-out-of-stock-customer',
				fetchOptions
			);
